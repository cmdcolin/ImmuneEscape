...
background_image = pygame.image.load('data/dark_image.jpg').convert()
background_image = pygame.transform.scale(background_image, (width, height))

# We can add sound to play in
sound = pygame.mixer.Sound('data/gameplaysong.wav')
...
while end_screen:
    ...
    draw_multiline_text(screen, text, font, (250, 250, 250), (0, 0))
